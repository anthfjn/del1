...
interfacegan_gender_male = '/content/PTI/editings/interfacegan_directions/Male_boundary.pt'
interfacegan_gender_celebhq = '/content/PTI/editings/interfacegan_directions/stylegan_celebahq_gender_w_boundary.pt'
