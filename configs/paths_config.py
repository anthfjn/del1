...
# interfacegan_Male_boundary = '/content/PTI/editings/interfacegan_directions/Male_boundary.pt'
interfacegan_stylegan_celebahq_gender_w_boundary = '/content/PTI/editings/interfacegan_directions/stylegan_celebahq_gender_w_boundary.pt'
